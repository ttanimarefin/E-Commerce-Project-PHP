                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="signin-container">
                            <form action="#" name="frm-login" method="post">
                                ...
                                <p class="form-row">
                                    <label for="user-pass">Password:<span class="requite">*</span></label>
                                    <input type="password" id="fid-pass" name="user-pass" value="" class="txt-input">
                                </p>
                                
                                    <input class="btn btn-submit btn-bold" type="submit" name="user_login_btn" value="Login" style="padding:15px 30px">
